...
<?php }else if($yoga_studio_post_option == '5_column'){ ?>
			...
			<div class="postbox smallpostimage p-2 mb-3">
	        	...
	        	<div class="overlay pt-2 text-center">
	        		<div class="date-box mb-2">
	        			...
	        			<?php }?>
	        			<?php if( get_theme_mod('yoga_studio_comment',true) != ''){ ?>
	      					<span class="entry-comments"><i class="fas fa-comments mr-2"></i> <?php comments_number( __('0 Comments','yoga-studio'), __('0 Comments','yoga-studio'), __('% Comments','yoga-studio')); ?></span>
	      				<?php }?>
	    			</div>
	        		<p><?php the_excerpt();?></p>
	        	</div>
