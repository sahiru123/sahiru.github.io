...
if ( ! defined( 'YOGA_STUDIO_LIVE_DEMO' ) ) {
	define('YOGA_STUDIO_LIVE_DEMO',__('https://www.ovationthemes.com/demos/yoga-meditation/','yoga-meditation'));
}
if ( ! defined( 'YOGA_STUDIO_BUY_PRO' ) ) {
	define('YOGA_STUDIO_BUY_PRO',__('https://www.ovationthemes.com/wordpress/yogi-wordpress-theme/','yoga-meditation'));
}
if ( ! defined( 'YOGA_STUDIO_PRO_DOC' ) ) {
	define('YOGA_STUDIO_PRO_DOC',__('https://www.ovationthemes.com/docs/ot-yoga-meditation-pro-doc','yoga-meditation'));
}
