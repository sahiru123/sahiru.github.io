...
== Changelog ==
    ...
    * Fix : Elementor deprecated warning.

    1.1.0 - July 15, 2022
    * Added: feature to load google font locally 

    1.0.9 - June 24, 2022
    * Fix  : WooCommerce payment gateaway checkbox issue
    * Fix  : Elementor page design refinement
    * Added: Tiktok icon to the social media settings

    1.0.8 - April 25, 2022
    * Fix: Wheel of Life plugin compatible fatal error fixed.
    * Fix: Secondary menu design issue in mobile.

    1.0.7 - December 16, 2021
    * Added: Wheel of Life section and compatibility
    
    1.0.6 - November 1, 2021
    * Fixed: tab navigation focus issue 

    1.0.5 - October 27, 2021
    * Fixed: accessibility for both child and parent
    * Fixed: design issue in elementor pages

    1.0.4 - August 11, 2021
    * Updated: removed default value for header phone, email and button 

    1.0.3 - July 29, 2021
    * Fixed: design issue in portfolio page template
    * Fixed: hover color issue in frontpage about section
    * Fixed: footer logo max width
    * Updated: Google Fonts

    1.0.2 - July 21, 2021
    * Removed : block widget for WordPress 5.8 compatibility
    * Fixed : accessibility issue in secondary navigation
