			...
			<div class="top-inner">				
				<div class="top-left">
                    ...
                    <?php if(get_theme_mod('email-txt') != '') { ?>
						<p><i class="fa fa-envelope"></i><a href="<?php echo esc_attr(esc_html('mailto:','yogasana-lite').get_theme_mod('email-txt')); ?>"><?php echo esc_url(get_theme_mod('email-txt')); ?></a></p>
                    <?php } ?>
