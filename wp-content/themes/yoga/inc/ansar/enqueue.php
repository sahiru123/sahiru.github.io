...
if ( ! function_exists( 'yoga_admin_scripts' ) ) :
function yoga_admin_scripts() {
    wp_enqueue_script( 'yoga-admin-script', get_template_directory_uri() . '/js/yoga-admin-script.js', array( 'jquery' ), '', true );
    wp_localize_script( 'yoga-admin-script', 'yoga_ajax_object',
        array( 'ajax_url' => admin_url( 'admin-ajax.php' ) )
    );
    wp_enqueue_style('yoga-admin-style-css', get_template_directory_uri() . '/css/customizer-controls.css');
}
endif;
add_action( 'admin_enqueue_scripts', 'yoga_admin_scripts' );
?>