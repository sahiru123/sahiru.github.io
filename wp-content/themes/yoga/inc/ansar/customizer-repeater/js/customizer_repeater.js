...
function customizer_repeater_refresh_general_control_values() {
    ...
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
			...
			var designation2 = jQuery(this).find('.customizer-repeater-designation2-control').val();
            ...
            if (text !== '' || image_url !== '' || title !== '' || subtitle !== '' || test_title !== '' || icon_value !== '' || link !== '' || designation !== '' || designation2 !== '' || open_new_tab !== '' || choice !== '' || social_repeater !== '' || shortcode !== '' || color !== '' || button_text !== '' || slide_format !== '' || video_url !== '') {
                values.push({
...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
        ...
        if (typeof th !== 'undefined') {
            ...
            if( th.find("#yoga_service_limit").val() == 3 )
                {
                   
                    th.parent().find(".customizer_yoga_upgrade_section").show();
                    return false;
                }
                else
                { 
                   var total_services_sections=parseInt(th.find("#yoga_service_limit").val())+1;
                   th.find("#yoga_service_limit").val(total_services_sections);
                   var limit = th.find("#yoga_service_limit").val();
                   if(limit <= 3)
                {
                    th.parent().find(".customizer_yoga_upgrade_section").hide();
                }
                } // }
            ...
            if (typeof field !== 'undefined') {
				...
				field.find('.customizer-repeater-designation-control').val('');
                 ...
                 /*Remove value from designation2  text field*/
                 field.find('.customizer-repeater-designation2-control').val('');
    ...
    theme_conrols.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        var total_service= parseInt(this1.find("#yoga_service_limit").val())-1;
        this1.find("#yoga_service_limit").val(total_service);
        var limit = this1.find("#yoga_service_limit").val();
        if(limit <= 3)
                {
                    this1.parent().find(".customizer_yoga_upgrade_section").hide();
                }
    ...
    theme_conrols.on('keyup','.customizer-repeater-designation2-control', function(){
