...
$wp_customize->remove_control('header_textcolor');
	...
	$wp_customize->selective_refresh->add_partial('yoga_head_info_one', array(
		'selector'        => '.info-left li:nth-child(1)',
		'render_callback' => 'businessup_customize_partial_yoga_head_info_one',
	));

	$wp_customize->selective_refresh->add_partial('yoga_head_info_two', array(
		'selector'        => '.info-left li:nth-child(2)',
		'render_callback' => 'businessup_customize_partial_yoga_head_info_two',
	));
	...
	function businessup_customize_partial_yoga_head_info_one() {
        return get_theme_mod( 'yoga_head_info_one' );
    }

    function businessup_customize_partial_yoga_head_info_two() {
        return get_theme_mod( 'yoga_head_info_two' );
    }
	?>