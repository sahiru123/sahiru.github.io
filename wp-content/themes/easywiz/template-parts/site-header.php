		...
		<div class="dt__header-navwrapper">
			<div class="dt__header-navwrapperinner">
				...
				<div class="dt__navbar dt-d-none dt-d-lg-block">
					<div class="dt__navbar-wrapper <?php if($cosmobit_hs_hdr_sticky=='1'): esc_attr_e('is--sticky','easywiz'); endif; ?>">
						<div class="dt-container">
							<div class="dt-row">
				...
				<div class="dt__mobilenav <?php if($cosmobit_hs_hdr_sticky=='1'): esc_attr_e('is--sticky','easywiz'); endif; ?> dt-d-lg-none">
