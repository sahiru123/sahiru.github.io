	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Cosmobit_Customize_Section_Pro(
				...
				'cosmobit',
				array(
                    'pro_text' => esc_html__( 'Upgrade to Easywiz Pro','easywiz' ),
                    'pro_url'  => 'https://desertthemes.com/themes/easywiz-pro/',
                    'priority' => 0
                )
			)
		);
...
Easywiz_Customize::get_instance();